...
const Main: React.FC = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h4'>Records Report</Typography>
      </Grid>
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} sm={4}>
                <FormControl fullWidth>
                  <InputLabel id='user-filter-label'>Member</InputLabel>
                  <Select
      ...
      {loading ? (
        ...
        <>
          ...
          <Grid item xs={12} lg={6}>
            <Card>
              <CardHeader title='Daily Record Count' />
              <CardContent>
                <ResponsiveContainer width='100%' height={300}>
          ...
          <Grid item xs={12}>
            <Card>
              <CardHeader title='Records by User' />
